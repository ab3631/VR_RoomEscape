...
public class LeftStand : MonoBehaviour
{
    [SerializeField] private ScalePuzzle _scalePuzzle; // Reference to the ScalePuzzle script
    [SerializeField] private BoxCollider _leftStandCollider; // Reference to the BoxCollider for the left stand
    private Vector3 _initialPosition; // Store the initial position of the left stand
    ...
    private void Awake()
    {
        ...
        _initialPosition = transform.position; // Store the initial position of the left stand
    }
